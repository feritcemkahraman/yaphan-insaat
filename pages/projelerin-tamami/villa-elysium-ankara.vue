  ...
  <div class="h-screen flex overflow-hidden bg-gray-800 text-white relative">
    ...
    <div class="relative w-full h-full">
      ...
      <div class="text-section">
        <h2 class="text-5xl font-light mb-6">Villa Elysium Ankara</h2>
        <p class="text-lg leading-relaxed opacity-90 mb-12 mt-6">
          Villa Elysium projemiz, modern mimari ve lüks yaşam standartlarını bir
          araya getiren özel bir projedir. Projemiz, doğal güzelliklerle çevrili
          bir alanda, sakin ve huzurlu bir yaşam sunmayı hedeflemektedir. Yüksek
          kaliteli malzemeler ve yenilikçi tasarım detayları ile donatılmıştır.
          Villa Elysium, konfor ve estetiği bir arada sunarak, sakinlerine eşsiz
          bir yaşam deneyimi vaat etmektedir. Projemiz, planlanan tarihlerde
          ilerlemekte olup, en yüksek müşteri memnuniyetini sağlamak için
...
export default {
  data() {
    return {
      images: [
        "/projeler/devameden/img/villa-elysium-ankara.webp",
        "/projeler/devameden/img/villa-elysium-ankara-2.webp",
        "/projeler/devameden/img/villa-elysium-ankara-3.webp",
        "/projeler/devameden/img/villa-elysium-ankara-4.webp",
        "/projeler/devameden/img/villa-elysium-ankara-5.webp",
        "/projeler/devameden/img/villa-elysium-ankara-6.webp",
        "/projeler/devameden/img/villa-elysium-ankara-7.webp",
        "/projeler/devameden/img/villa-elysium-ankara-8.webp",
        "/projeler/devameden/img/villa-elysium-ankara-9.webp",
        "/projeler/devameden/img/villa-elysium-ankara-10.webp",
        "/projeler/devameden/img/villa-elysium-ankara-11.webp",
        "/projeler/devameden/img/villa-elysium-ankara-12.webp",
        "/projeler/devameden/img/villa-elysium-ankara-13.webp",
        "/projeler/devameden/img/villa-elysium-ankara-14.webp",
        "/projeler/devameden/img/villa-elysium-ankara-15.webp",
        "/projeler/devameden/img/villa-elysium-ankara-16.webp",
        "/projeler/devameden/img/villa-elysium-ankara-17.webp",
        "/projeler/devameden/img/villa-elysium-ankara-18.webp",
        "/projeler/devameden/img/villa-elysium-ankara-19.webp",
        "/projeler/devameden/img/villa-elysium-ankara-20.webp",
        "/projeler/devameden/img/villa-elysium-ankara-21.webp",
        "/projeler/devameden/img/villa-elysium-ankara-22.webp",
        "/projeler/devameden/img/villa-elysium-ankara-23.webp",
        "/projeler/devameden/img/villa-elysium-ankara-24.webp",
      ],
      currentIndex: 0,
      isMobile: false,
      windowWidth: 0,
