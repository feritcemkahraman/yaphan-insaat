  ...
  <div class="h-screen flex overflow-hidden bg-gray-800 text-white relative">
    ...
    <div class="relative w-full h-full">
      ...
      <div class="text-section">
        <h2 class="text-5xl font-light mb-6">Apartman Projemiz</h2>
        <p class="text-lg leading-relaxed opacity-90 mb-12 mt-6">
          Tamamlanmış ve teslim aşamasına gelmiş olan apartmanımız, sakinlerine
          günümüz yaşam standartlarına uygun modern donanımlar, güvenlikli yaşam
          alanları ve yeşil alanlar sunuyor. Projemiz, her biri geniş balkonlu,
          aydınlık ve kullanışlı daireler ile yaşam kalitesini arttırmayı
          hedefliyor.
        </p>
      </div>
...
export default {
  data() {
    return {
      images: [
        "/projeler/tamamlanan/img/yaphan-apartman.webp",
        "/projeler/tamamlanan/img/yaphan-apartman-2.webp",
        "/projeler/tamamlanan/img/yaphan-apartman-3.webp",
        "/projeler/tamamlanan/img/yaphan-apartman-4.webp",
        "/projeler/tamamlanan/img/yaphan-apartman-5.webp",
        "/projeler/tamamlanan/img/yaphan-apartman-6.webp",
      ],
      currentIndex: 0,
      isMobile: false,
      windowWidth: 0,
