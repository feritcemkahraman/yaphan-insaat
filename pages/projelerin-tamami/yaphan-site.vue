  ...
  <div class="h-screen flex overflow-hidden bg-gray-800 text-white relative">
    ...
    <div class="relative w-full h-full">
      ...
      <div class="text-section">
        <h2 class="text-5xl font-light mb-6">Site Projemiz</h2>
        <p class="text-lg leading-relaxed opacity-90 mb-12 mt-6">
          Tamamlanmış olan yeni site projemiz, sakinlerine modern, güvenli ve
          konforlu bir yaşam alanı sunuyor. Huzurlu bir ortamda, yüksek kaliteye
          sahip inşaat malzemeleri ve modern tasarım anlayışıyla şekillendirilen
          bu proje, tüm detaylarıyla yaşam kalitesini yükseltmeyi amaçlıyor.
        </p>
      </div>
...
export default {
  data() {
    return {
      images: [
        "/projeler/tamamlanan/img/yaphan-apartman2.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-2.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-3.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-4.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-5.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-6.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-7.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-8.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-9.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-10.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-11.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-12.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-13.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-14.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-15.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-16.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-17.webp",
        "/projeler/tamamlanan/img/yaphan-apartman2-18.webp",
      ],
      currentIndex: 0,
      isMobile: false,
      windowWidth: 0,
