  ...
  <div class="h-screen flex overflow-hidden bg-gray-800 text-white relative">
    ...
    <div class="relative w-full h-full">
      ...
      <div class="text-section">
        <h2 class="text-5xl font-light mb-6">Tower Projemiz</h2>
        <p class="text-lg leading-relaxed opacity-90 mb-12 mt-6">
          Tamamlanmış olan yeni tower projemiz, sakinlerine modern, güvenli ve
...
export default {
  data() {
    return {
      images: [
        "/projeler/tamamlanan/img/yaphan-tower.webp",
        "/projeler/tamamlanan/img/yaphan-tower-2.webp",
        "/projeler/tamamlanan/img/yaphan-tower-3.webp",
        "/projeler/tamamlanan/img/yaphan-tower-4.webp",
        "/projeler/tamamlanan/img/yaphan-tower-5.webp",
        "/projeler/tamamlanan/img/yaphan-tower-6.webp",
        "/projeler/tamamlanan/img/yaphan-tower-7.webp",
        "/projeler/tamamlanan/img/yaphan-tower-8.webp",
        "/projeler/tamamlanan/img/yaphan-tower-9.webp",
        "/projeler/tamamlanan/img/yaphan-tower-10.webp",
        "/projeler/tamamlanan/img/yaphan-tower-11.webp",
      ],
      currentIndex: 0,
      isMobile: false,
      windowWidth: 0,
