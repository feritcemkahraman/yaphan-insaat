    ...
    <div class="relative w-full h-full">
      ...
      <div class="text-section">
        <h2 class="text-5xl font-light mb-6">
          Kristal Düşler Konağı – Zengin Bir Yaşam Alanı
        </h2>
        <p class="text-lg leading-relaxed opacity-90 mb-12 mt-6">
          Kristal Düşler Konağı, adını her iki katından da izlenebilen geniş
          panoramik manzarasından alıyor. Hem şehir ışıklarını hem de ufuk
          çizgisine kadar uzanan doğayı kucaklayan bu konum, huzur ve lüksü bir
          arada sunuyor. Villa, cephede kullanılan tonların uyumuyla farklı
          zaman dilimlerinde estetik bir yansıma sunarken, geniş camları
          sayesinde doğal ışıkla dolup taşar. Sabahları uyandığınızda, camlardan
          süzülen ilk gün ışığıyla karşılanırsınız ve her akşamüstü, ufukta
          batan güneşin büyüleyici manzarası eşliğinde günü huzurla
          tamamlarsınız.
        </p>
      </div>
...
export default {
  data() {
    return {
      images: [
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi.webp",
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi-2.webp",
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi-3.webp",
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi-4.webp",
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi-5.webp",
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi-6.webp",
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi-7.webp",
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi-8.webp",
        "/projeler/tamamlanan/img/yaphan-kristal-dusler-konagi-9.webp",
      ],
      currentIndex: 0,
      isMobile: false,
      windowWidth: 0,
